...
# has_app_changes = !git.modified_files.grep(/DangerRulesTest/).empty?
# ## Then, we should check if tests are updated
# has_test_changes = !git.modified_files.grep(/DangerRulesTest/).empty?
# ## Then, we should check if UI tests are updated
# has_ui_test_changes = !git.modified_files.grep(/DangerRulesTest/).empty?
